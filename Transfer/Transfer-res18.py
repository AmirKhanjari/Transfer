...
class Train(pl.LightningModule):
    def __init__(self, num_classes, learning_rate):
        ...
        state_dict = torch.load('/projappl/project_2010727/Saved_Models/ResNet18_lr0.01_e8.pth')
        
        #Remove fully connected layer parameters from state dictionary
    ...
    def configure_optimizers(self):
        return torch.optim.Adam(self.model.fc.parameters(), lr=self.learning_rate)

def main(experiment_name, learning_rate):
    # Set paths
    data_dir = '/scratch/project_2010727/data/Detect dataset/Cropped images'
    csv_file = '/projappl/project_2010727/taxonomist/data/processed/finbenthic1-3/01_finbenthic1-3_processed_5splits_taxon.csv'
